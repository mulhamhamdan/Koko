  ...
  return (
    <section className="relative min-h-[92svh] flex flex-col justify-center items-center pt-24 pb-12 overflow-hidden px-6">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="relative z-10 max-w-4xl w-full text-center space-y-10 flex flex-col items-center"
      >
        
        {/* Intro Tag */}
        <motion.div variants={heroItem} className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full glassmorphism text-xs font-medium tracking-wide">
        ...
        <motion.div variants={heroItem} className="space-y-4 max-w-3xl">
        ...
        {/* Editorial Subtext */}
        <motion.p variants={heroItem} className="max-w-xl text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed font-sans">
        ...
        <motion.div variants={heroItem} className="w-full max-w-lg mt-4 bg-white/60 dark:bg-card-dark/60 p-2.5 rounded-2xl border border-black/5 dark:border-white/5 backdrop-blur-md shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              ...
              className={`p-4 rounded-xl border flex flex-col items-center gap-2 transition-all duration-300 hover:-translate-y-0.5 ${
        ...
        {/* Scroll Indicator */}
        <motion.div variants={heroItem} className="pt-8 animate-bounce flex flex-col items-center text-gray-400 dark:text-gray-500">
